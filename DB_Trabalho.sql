...
SELECT dbo.CLIENTE.COD_CLIENTE, dbo.CLIENTE.NOME_CLIENTE, dbo.CLIENTE.FOTO_CLIENTE, dbo.CLIENTE.DATANASC_CLIENTE, dbo.SEXO.NOME_SEXO, dbo.BAIRRO.NOME_BAIRRO, dbo.CIDADE.NOME_CIDADE, dbo.RUA.NOME_RUA, 
                  dbo.TRABALHO.NOME_TRABALHO, dbo.CEP.NUMERO_CEP
FROM     dbo.BAIRRO INNER JOIN
                  dbo.CLIENTE ON dbo.BAIRRO.COD_BAIRRO = dbo.CLIENTE.COD_BAIRRO_FK INNER JOIN
                  dbo.CIDADE ON dbo.CLIENTE.COD_CIDADE_FK = dbo.CIDADE.COD_CIDADE INNER JOIN
                  dbo.RUA ON dbo.CLIENTE.COD_RUA_FK = dbo.RUA.COD_RUA INNER JOIN
                  dbo.SEXO ON dbo.CLIENTE.COD_SEXO_FK = dbo.SEXO.COD_SEXO INNER JOIN
                  dbo.TRABALHO ON dbo.CLIENTE.COD_TRABALHO_FK = dbo.TRABALHO.COD_TRABALHO INNER JOIN
                  dbo.CEP ON dbo.CLIENTE.COD_CEP_FK = dbo.CEP.COD_CEP;
create view DadosTelefone as
				  SELECT dbo.TELEFONE.NUMERO, dbo.TELEFONE.COD_TELEFONE, dbo.OPERADORA.NOME_OPERADORA
FROM     dbo.OPERADORA INNER JOIN
                  dbo.TELEFONE ON dbo.OPERADORA.COD_OPERADORA = dbo.TELEFONE.COD_OPERADORA_FK;